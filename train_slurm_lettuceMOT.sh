...
srun $PYTHON -u train.py ./configs/LettuceMOT/mask_rcnn_internimage_b_fpn_3x_coco.py --work-dir ./applemot_log/ --load-from ./models/coco_pretrained/mask_rcnn_internimage_b_fpn_3x_coco.pth
